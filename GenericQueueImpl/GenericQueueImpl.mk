...
ObjectsFileList        :="GenericQueueImpl.txt"
PCHCompileFlags        :=
...
Objects0=$(IntermediateDirectory)/GenericQueueImpl.cpp$(ObjectSuffix) 
...
$(IntermediateDirectory)/GenericQueueImpl.cpp$(PreprocessSuffix): GenericQueueImpl.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/GenericQueueImpl.cpp$(PreprocessSuffix) "GenericQueueImpl.cpp"
